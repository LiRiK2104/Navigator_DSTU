...
public class GwNode : MonoBehaviour
{
    ...
    [HideInInspector] public int parentNodeID;
    ...
    public void AddConnection(int connectedNodeID, bool disabled, float speedWeight, Transform[] subnodes)
    {
    ...
    /// <param name="speedWeight">Speed weight score of connection.</param>
    /// <param name="subnodes">Array of subnode positions, closest to furthest.</param>
    public void UpdateConnection(int connectedNodeID, bool isDisabled, float speedWeight, Transform[] subnodes)
    {
        if (connections.ContainsKey(connectedNodeID))
        {
